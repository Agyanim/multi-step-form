...
const Thanks = () => {
  return (
    <main className='flex flex-col justify-center items-center text-center w-[89%] lg:w-[75%] mx-auto h-[25rem] lg:h-0 lg:mt-[17rem] font-ubuntu lg:ml-[8%] font-semibold'>
